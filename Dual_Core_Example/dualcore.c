...
//This routine will run in core 0
void readRpTemp(void)
{
	while(1)
	{
...
int main()
{
	...
	while(1)
	{
		...
		//Print out the average after MAX_COUNT	reading
		if(++count == MAX_COUNT)
		{
